...
console.log ("There are enough elements in the array")
}
...
//Code Here
for (let a =0; a < listOfNumbers.length; a++){
  if (listOfNumbers[a]%3 === 0){
    console.log (`${listOfNumbers[a]} is divisible by 3`)
  }
  }
...
//Code Here
for (let b=letters.length -1; b>=0; b--){
